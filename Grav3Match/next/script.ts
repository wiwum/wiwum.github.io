...
const next = [["white", "white"],["white", "white"],["white", "white"]];
let gameArr = [["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"], ["black", "black", "black", "black", "black", "black", "black", "black"]];
let r = false;
let l = false;
let f = false;
let score = 0;
...
function setScreen(arr: string[][]){
    ...
    if(n00){
        n00.style.color = next[0][0];
        n00.style.backgroundColor = next[0][0];
    }
    const n01 = document.getElementById("n01");
    if(n01){
        n01.style.color = next[0][1];
        n01.style.backgroundColor = next[0][1];
    }
    const n10 = document.getElementById("n10");
    if(n10){
        n10.style.color = next[1][0];
        n10.style.backgroundColor = next[1][0];
    }
    const n11 = document.getElementById("n11");
    if(n11){
        n11.style.color = next[1][1];
        n11.style.backgroundColor = next[1][1];
    }
    const n20 = document.getElementById("n20");
    if(n20){
        n20.style.color = next[2][0];
        n20.style.backgroundColor = next[2][0];
    }
    const n21 = document.getElementById("n21");
    if(n21){
        n21.style.color = next[2][1];
        n21.style.backgroundColor = next[2][1];
    }
}
...
function nextPiece(){
    piece.x = 3
    piece.y = 0;
    piece.color1 = next[0][0];
    piece.color2 = next[0][1];
    next[0][0] = next[1][0];
    next[0][1] = next[1][1];
    next[1][0] = next[2][0];
    next[1][1] = next[2][1];
...
function genColor(): string {
    let decideColor = Math.floor(Math.random() * 4);
    if(decideColor === 0)
        return "red";
    if(decideColor === 1)
        return "green";
